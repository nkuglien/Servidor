...
public class TestInsumo {
	...
	public static void main(String[] args) {
		...
		lote1 = new LoteInsumo(null, 10, 10, p1, insumo1, null, Float.parseFloat("100"), null);
		lote1.save();
		...
		lote2 = new LoteInsumo(null, 7, 7, p2, insumo2, null, Float.parseFloat("150"), null);
		lote2.save();
		...
		lote3 = new LoteInsumo(null, 5, 5, p3, insumo3, null, Float.parseFloat("200"), null);
		lote3.save();
		...
		lote4 = new LoteInsumo(null, 8, 8, p4, insumo4, null, Float.parseFloat("175"), null);
		lote4.save();
