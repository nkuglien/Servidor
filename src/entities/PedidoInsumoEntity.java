...
public class PedidoInsumoEntity {
	...
	public PedidoInsumo toBO() {
		...
		PedidoInsumo pedido = new PedidoInsumo(this.getId(), this.getEstado(), this.getFechaGeneracion(),
				this.getFechaDespacho(), this.getFechaDespachoReal(),
				this.getProveedor() != null ? this.getProveedor().toBO() : null, this.getInsumo().toBO(),
				this.getPrecioUnidad(), this.getCantidad(), ordenes);
